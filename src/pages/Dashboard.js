...
const Dashboard = ({ user }) => {
    ...
    useEffect(() => {
        const fetchAvailableTimes = async () => {
            try {
                const res = await axios.get('http://192.168.178.86:5000/api/get-times', {
    ...
    const handleBooking = async () => {
        ...
        try {
            const response = await axios.post('http://192.168.178.86:5000/api/book-time', {
    ...
    const handleDeleteBooking = async () => {
        ...
        try {
            const response = await axios.delete(`http://192.168.178.86:5000/api/book-time/${bookingId}`);
